...
Thank you for your interest in contributing to [learn-ai](https://github.com/dileepadev/learn-ai)! We welcome contributions, including bug fixes, feature enhancements, documentation improvements, and other general improvements.
...
1. **Fork the repository**  
   ...
   To fork the repository, click the **Fork** button in the top right corner of this page or click [here to fork the repository](https://github.com/dileepadev/learn-ai/fork).
...
- Refer to the following templates and guidelines before submitting your changes:
  - [learn-ai/](./) - Root directory of the repository
